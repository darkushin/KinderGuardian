...
def trim_video(input_path, output_path, limit):
    """
    Given a path to a video and the number of frames that should be taken from it, trim the video to the first
    `limit` frames. Saves the output to the `output_path` location.
    """
